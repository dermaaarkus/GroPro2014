...
public class InputFileReader extends InputReader {
	...
	public GameState getFirstGameState()  throws FileNotFoundException {
		...
		if(line != null && !line.startsWith("#"))
		{
			...
			throw new InputMismatchException("Bei Einlesen wurden keine Daten gefunden! Die Datei muss eine Zeile mit den Werten der Reihen haben.");
		}
	}

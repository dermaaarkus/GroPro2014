...
public class RandomStrategy extends AbstractStrategy
{
	...
	public GameState getNextGameState(GameState gameState) {
		...
		else
		{
			...
			do { // suche eine zufällige Reihe != 0
			...
			int randomValue = 1 + randomGenerator.nextInt(columns.get(columnIndex));
			
			resultGameState.changeValueOfColumn(columnIndex, columns.get(columnIndex) - randomValue);
		}
